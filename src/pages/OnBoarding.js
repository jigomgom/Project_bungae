            ...
            >
              ...
              <OnBoardModalContentWrap>
                <OnboardTitle>이제 벙글하러 가요.</OnboardTitle>
                  <img style={{ width:"70%", marginTop:"25px", marginBottom:"40px"}} src={IconLoginLogo} alt=""/>
                    ...
                    : <OnboardButton style={{ backgroundColor: "#FFC634", color:"black" }}>벙글하러 가기</OnboardButton> }
                </OnBoardModalContentWrap>
              </SwiperSlide>
            </Swiper>
          </OnBoardModalInner>
